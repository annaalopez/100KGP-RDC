...
unsolved_recessive_lof_sec_grch37 <- filter(unsolved_recessive_lof_sec, unsolved_recessive_lof_sec[12] == "GRCh37")
...
unsolved_recessive_lof_sec_grch38 <- filter(unsolved_recessive_lof_sec, unsolved_recessive_lof_sec[12] == "GRCh38")
...
unsolved_recessive_lof_hsp_grch37 <- filter(unsolved_recessive_lof_hsp, unsolved_recessive_lof_hsp[12] == "GRCh37")
...
unsolved_recessive_lof_hsp_grch38 <- filter(unsolved_recessive_lof_hsp, unsolved_recessive_lof_hsp[12] == "GRCh38")
...
unsolved_recessive_missense_sec_grch37 <- filter(unsolved_recessive_missense_sec, unsolved_recessive_missense_sec[12] == "GRCh37")
...
unsolved_recessive_missense_sec_grch38 <- filter(unsolved_recessive_missense_sec, unsolved_recessive_missense_sec[12] == "GRCh38")
...
unsolved_recessive_missense_hsp_grch37 <- filter(unsolved_recessive_missense_hsp, unsolved_recessive_missense_hsp[12] == "GRCh37")
...
unsolved_recessive_missense_hsp_grch38 <- filter(unsolved_recessive_missense_hsp, unsolved_recessive_missense_hsp[12] == "GRCh38")
...
unsolved_recessive_LOFmissense_sec_grch37 <- filter(unsolved_recessive_LOFmissense_sec, unsolved_recessive_LOFmissense_sec[12] == "GRCh37")
...
unsolved_recessive_LOFmissense_sec_grch38 <- filter(unsolved_recessive_LOFmissense_sec, unsolved_recessive_LOFmissense_sec[12] == "GRCh38")
...
unsolved_recessive_LOFmissense_hsp_grch37 <- filter(unsolved_recessive_LOFmissense_hsp, unsolved_recessive_LOFmissense_hsp[12] == "GRCh37")
...
unsolved_recessive_LOFmissense_hsp_grch38 <- filter(unsolved_recessive_LOFmissense_hsp, unsolved_recessive_LOFmissense_hsp[12] == "GRCh38")
...
unsolved_denovo_lof_sec_grch37 <- filter(unsolved_denovo_lof_sec, unsolved_denovo_lof_sec[12] == "GRCh37")
...
unsolved_denovo_lof_sec_grch38 <- filter(unsolved_denovo_lof_sec, unsolved_denovo_lof_sec[12] == "GRCh38")
...
unsolved_denovo_lof_hsp_grch37 <- filter(unsolved_denovo_lof_hsp, unsolved_denovo_lof_hsp[12] == "GRCh37")
...
unsolved_denovo_lof_hsp_grch38 <- filter(unsolved_denovo_lof_hsp, unsolved_denovo_lof_hsp[12] == "GRCh38")
...
unsolved_denovo_missense_sec_grch37 <- filter(unsolved_denovo_missense_sec, unsolved_denovo_missense_sec[12] == "GRCh37")
...
unsolved_denovo_missense_sec_grch38 <- filter(unsolved_denovo_missense_sec, unsolved_denovo_missense_sec[12] == "GRCh38")
...
unsolved_denovo_missense_hsp_grch37 <- filter(unsolved_denovo_missense_hsp, unsolved_denovo_missense_hsp[12] == "GRCh37")
...
unsolved_denovo_missense_hsp_grch38 <- filter(unsolved_denovo_missense_hsp, unsolved_denovo_missense_hsp[12] == "GRCh38")
...
unsolved_denovo_LOFmissense_sec_grch37 <- filter(unsolved_denovo_LOFmissense_sec, unsolved_denovo_LOFmissense_sec[12] == "GRCh37")
...
unsolved_denovo_LOFmissense_sec_grch38 <- filter(unsolved_denovo_LOFmissense_sec, unsolved_denovo_LOFmissense_sec[12] == "GRCh38")
...
unsolved_denovo_LOFmissense_hsp_grch37 <- filter(unsolved_denovo_LOFmissense_hsp, unsolved_denovo_LOFmissense_hsp[12] == "GRCh37")
...
unsolved_denovo_LOFmissense_hsp_grch38 <- filter(unsolved_denovo_LOFmissense_hsp, unsolved_denovo_LOFmissense_hsp[12] == "GRCh38")
...
unsolved_comphet_lof_sec_grch38 <- filter(unsolved_comphet_lof_sec, unsolved_comphet_lof_sec[12] == "GRCh38")
...
write.table(unsolved_comphet_lof_sec_grch38_VEP_list, "VEP_comphet_lof_sec_grch38.vcf", quote = FALSE, sep = " ", row.names = FALSE, col.names = FALSE)

# HSP GENES
table(unsolved_comphet_lof_hsp[12])

unsolved_comphet_lof_hsp_grch37 <- filter(unsolved_comphet_lof_hsp, unsolved_comphet_lof_hsp[12] == "GRCh37")
...
unsolved_comphet_lof_hsp_grch38 <- filter(unsolved_comphet_lof_hsp, unsolved_comphet_lof_hsp[12] == "GRCh38")
...
unsolved_denovo_comphet_sec_grch37 <- filter(unsolved_comphet_missense_sec, unsolved_comphet_missense_sec[12] == "GRCh37")
unsolved_denovo_comphet_sec_grch37$base <- paste(as.character(unsolved_comphet_missense_sec_grch37$reference), "/", as.character(unsolved_comphet_missense_sec_grch37$alternate))
unsolved_denovo_comphet_sec_grch37_VEP <- unsolved_comphet_missense_sec_grch37 %>% mutate(start = position, end = position + (nchar(alternate) + nchar(reference) -2), strand = 1) %>% select(chromosome, start, end, base, strand)
unsolved_denovo_comphet_sec_grch37_VEP_list <- unsolved_comphet_missense_sec_grch37_VEP[!duplicated(unsolved_comphet_missense_sec_grch37_VEP[,2:4]),]
unsolved_denovo_comphet_sec_grch37_VEP_list$base <- str_replace_all(unsolved_comphet_missense_sec_grch37_VEP_list$base, " ", "")
...
unsolved_comphet_missense_sec_grch38 <- filter(unsolved_comphet_missense_sec, unsolved_comphet_missense_sec[12] == "GRCh38")
...
unsolved_comphet_missense_hsp_grch37 <- filter(unsolved_comphet_missense_hsp, unsolved_comphet_missense_hsp[12] == "GRCh37")
...
unsolved_comphet_missense_hsp_grch38 <- filter(unsolved_comphet_missense_hsp, unsolved_comphet_missense_hsp[12] == "GRCh38")
...
unsolved_comphet_LOFmissense_sec_grch37 <- filter(unsolved_comphet_LOFmissense_sec, unsolved_comphet_LOFmissense_sec[12] == "GRCh37")
...
unsolved_comphet_LOFmissense_sec_grch38 <- filter(unsolved_comphet_LOFmissense_sec, unsolved_comphet_LOFmissense_sec[12] == "GRCh38")
...
unsolved_comphet_LOFmissense_hsp_grch37 <- filter(unsolved_comphet_LOFmissense_hsp, unsolved_comphet_LOFmissense_hsp[12] == "GRCh37")
...
write.table(unsolved_comphet_LOFmissense_hsp_grch37_VEP_list, "VEP_comphet_LOFmissense_hsp_grch37", quote = FALSE, sep = " ", row.names = FALSE, col.names = FALSE)

unsolved_comphet_LOFmissense_hsp_grch38 <- filter(unsolved_comphet_LOFmissense_hsp, unsolved_comphet_LOFmissense_hsp[12] == "GRCh38")
